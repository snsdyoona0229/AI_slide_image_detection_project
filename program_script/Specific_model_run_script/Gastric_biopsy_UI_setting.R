conditionalPanel(condition = "input.Select_customuze_AI_to_use == 'Gastric_biopsy'",
                column(3,
                        tabsetPanel(
                          tabPanel("Upload Gastric_biopsy image", 
                                   br(),
                         ...
                         br(),
                          ...
                          tabPanel("Load Gastric_biopsy history image", 
