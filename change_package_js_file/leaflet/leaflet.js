...
function mouseHandler2(mapId, layerId, group, eventName, extraInfo) {
  return function (e) {
    if (!_htmlwidgets2["default"].shinyMode) return;
    var layer = e.target;
    ...
    var eventInfo = _jquery2["default"].extend({
      ...
      group: group
    } : null, layer.toGeoJSON(), extraInfo);
    ...
    var _loop2 = function _loop2(i) {
      if (_jquery2["default"].isNumeric(df.get(i, "lat")) && _jquery2["default"].isNumeric(df.get(i, "lng"))) {
        (function () {
          ...
          marker.on("contextmenu", mouseHandler(this.id, thisId, thisGroup, "marker_right_click", extraInfo), this);
...
methods.addGeoJSON = function (data, layerId, group, style) {
  ...
  var gjlayer = _leaflet2["default"].geoJson(data, {
    ...
    onEachFeature: function onEachFeature(feature, layer) {
      ...
      layer.on("contextmenu", mouseHandler(self.id, layerId, group, "geojson_right_click", extraInfo), this);
      layer.on("dblclick", mouseHandler(self.id, layerId, group, "geojson_double_click", extraInfo), this);
      layer.on("pm:dragend", mouseHandler2(self.id, layerId, group, "geojson_move", extraInfo), this);
      //layer.on("mousedown", mouseHandler(self.id, layerId, group, "geojson_mousedown", extraInfo), this);
